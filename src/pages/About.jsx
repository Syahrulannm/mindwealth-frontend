...
import { faBookOpen, faEnvelope, faGlobe, faLaptopCode, faLightbulb, faLink, faMagnifyingGlass, faSeedling, faUsers } from "@fortawesome/free-solid-svg-icons";
      ...
      <main className="container mx-auto px-6 py-16">
        ...
        <section className="mb-20">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-1/2">
              <img
                src="https://images.unsplash.com/photo-1551491016-810459e3e2e0?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fHBoc3ljb2xvZ3klMjBhbmQlMjB0ZWNobm9sb2d5fGVufDB8fDB8fHww?"
        ...
        <section className="py-12 bg-sky-50 dark:bg-gray-900 mb-20">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold text-gray-800 dark:text-white mb-8">Meet the Author</h2>
            <div className="flex flex-col items-center">
              {/* <!-- Foto Penulis --> */}
              <img src="/syahrul-hero.webp" alt="Syahrul Annam" className="w-32 h-32 rounded-full shadow-lg border-4 border-sky-500 dark:border-sky-400 mb-4 object-cover" />
              {/* <!-- Nama & Peran --> */}
              <h3 className="text-xl font-semibold text-gray-800 dark:text-white">Syahrul Annam</h3>
        ...
        {/* <!-- Achievements --> */}
        <section className="bg-slate-900 text-white rounded-xl p-12 mb-20">
          <h2 className="text-3xl font-bold mb-12 text-center">Our Impact</h2>
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-sky-600 dark:text-sky-400 text-4xl mb-3">
                <FontAwesomeIcon icon={faBookOpen} />
              </div>
              <h3 className="text-2xl font-bold text-white">50+</h3>
              {/* <p className="text-gray-600 dark:text-gray-300 text-sm">Insightful articles published</p> */}
              <div className="text-gray-300">Insightful articles published</div>
            </div>
            <div>
              <div className="text-sky-600 dark:text-sky-400 text-4xl mb-3">
              ...
              {/* <p className="text-gray-600 dark:text-gray-300 text-sm">Countries reached</p> */}
            ...
            <div>
              ...
              {/* <p className="text-gray-600 dark:text-gray-300 text-sm">Community of learners & changemakers</p> */}
              <div className="text-gray-300">Community of learners & changemakers</div>
            </div>
          </div>
        </section>
        {/* <!-- Call to Action --> */}

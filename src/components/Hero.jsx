        ...
        <div className="flex flex-col-reverse md:flex-row items-center">
          <div className="md:w-1/2 mb-12 md:mb-0 fly-in text-center md:text-start">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 dark:text-gray-100">
              Nourish Your <span className="bg-gradient-custom gradient-text ">Mind</span>, Grow Your <span className="gradient-text bg-gradient-custom">Wealth</span>
            </h1>
            <p className="text-lg md:text-xl text-secondary-600 dark:text-gray-200 mb-8 leading-relaxed">Thoughtful perspectives on psychology, personal growth, technology and designing a meaningful life.</p>

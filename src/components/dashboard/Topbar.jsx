...
// Komponen ini menerima 'toggleMenu' sebagai props
export default function Topbar() {
  ...
  return (
    <>
      <div id="edit" className="flex items-center justify-between h-16 bg-gradient-to-b from-sky-100 to-sky-50 dark:from-gray-700 dark:to-blue-500 border-b border-gray-200 dark:border-gray-950">
        <div className="flex items-center px-4 py-2">
          <div className="relative mx-auto text-gray-600 dark:text-gray-200">
            <input
              className="border border-gray-300 dark:border-gray-500 h-10 w-64 md:w-96 px-4 pr-16 rounded-lg text-sm placeholder-current focus:outline-none dark:bg-gray-800  dark:text-gray-200"
              type="search"
              name="search"
              placeholder="Search"
            />
        ...
        {/* <!-- notification --> */}
        <div className="flex items-center space-x-3 md:space-x-6  mr-4">
          <div className="hidden md:flex space-x-3 items-center">
            <ThemeToggle />
            <Link href="#" className=" text-gray-600 hover:text-gray-800 dark:text-gray-200 dark:hover:text-gray-300">
            ...
            {/* <!-- parametre --> */}
            <Link className="text-gray-600 hover:text-gray-800 dark:text-gray-200 dark:hover:text-gray-300">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path
                  fill="currentColor"
            ...
            {/* <!-- logout --> */}
            <Link className="flex items-center text-gray-600 hover:text-gray-800 dark:text-gray-200 dark:hover:text-gray-300">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
          ...
          {/* <!-- Humberger --> */}
          <button onClick={() => setIsOpen(true)} className="md:hidden flex items-center dark:text-gray-100 text-gray-800 hover:scale-105">
      ...
      <div
        ...
        className={`fixed top-0 right-0 w-64 h-full bg-gradient-to-b from-gray-700 to-blue-500 px-2 py-4 gap-10 rounded-2xl shadow-lg z-50 transform transition-smooth ${isOpen ? "translate-x-0" : "translate-x-full"}`}
      >
        {/* Header */}
        ...
        <div className="flex flex-col flex-1 gap-3">
          <Link to="/admin" onClick={() => setIsOpen(false)} className="flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-400 hover:bg-opacity-25 rounded-2xl transition-smooth">
          ...
          <Link to="/admin/articles/list" onClick={() => setIsOpen(false)} className="flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-400 hover:bg-opacity-25 rounded-2xl transition-smooth">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="mr-[8px]">
          ...
          <div className="flex items-center px-3 py-2 text-gray-100 hover:bg-gray-400 hover:bg-opacity-25 rounded-2xl transition-smooth">
            <ThemeToggle /> <span className="pl-1">Theme</span>
          </div>
        </div>
      </div>
    </>
